...
if [ -z "$BBS_HOME" ] || [ -z "$HTMPATH" ] || [ -z "$CGIPATH" ] || [ -z "$LOCALIP" ]; then
	echo "Typical Usage (change the values as you need):"
	echo "  BBS_HOME=/home/bbs HTMPATH=/home/apache/htdocs/bbs CGIPATH=/home/apache/cgi-bin/bbs LOCALIP=202.117.1.8 sudo -E ./PrepDirs.sh"
	exit 1
fi
