...
const char* style_to_str(int style)
{
	switch (style) {
	// 未验证
	case NO_ACTIVE:     return "\xCE\xB4\xD1\xE9\xD6\xA4";
	// 信箱
	case MAIL_ACTIVE:   return "\xD0\xC5\xCF\xE4";
	// 手机号码
	case PHONE_ACTIVE:  return "\xCA\xD6\xBB\xFA\xBA\xC5\xC2\xEB";
	// 其他证件
	case IDCARD_ACTIVE: return "\xC6\xE4\xCB\xFB\xD6\xA4\xBC\xFE";
	// 手工激活
	case FORCE_ACTIVE:  return "\xCA\xD6\xB9\xA4\xBC\xA4\xBB\xEE";
	// 未知
