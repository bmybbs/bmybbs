...
<body>
	...
	<div class="padbottom">
		<form action="nmail_do.php?>" method="post">
		<div>
			<?php
				if($_GET['e']!="")
			...
			<input class="textinput" type="text" name="title" value="<?php echo $_GET['t'] ?>"/>
			<br/><span class="hint">收信人</span> <br/>
			<input class="textinput" type="text" name="userid" maxlength="20" value="<?php echo $_GET['touser']?>"/>
