...
- 2026-05-29 10:18 | update | migration/logging-system/phase-2-database-design.md, migration/logging-system/phase-2-importer.md, use-cases/00-0001-import-one-daily-log.md, implementation-plans/00-0001-logging-importer.md | Normalized import source filename tracking into `log_source_files` to avoid repeating the same filename on every imported line.
- 2026-05-31 14:30 | update | migration/logging-system/phase-2-importer.md, use-cases/00-0001-import-one-daily-log.md, implementation-plans/00-0001-logging-importer.md | Planned constrained `--fast-import` mode using one transaction per never-imported source file.
- 2026-05-31 14:52 | update | implementation-plans/00-0001-logging-importer.md | Implemented constrained `--fast-import` mode and updated the month import operator example.
- 2026-06-01 11:45 | update | migration/logging-system/phase-2-database-design.md, migration/logging-system/phase-2-importer.md, implementation-plans/00-0002-logging-importer-parser.md | Split successful login records into `log_login_success_events` and narrowed `log_session_events` to session-control events.
