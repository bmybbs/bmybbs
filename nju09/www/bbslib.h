...
time_t post_article_1984(char *board, char *title, char *file, char *id, char *nickname, char *ip, int sig, int mark, int outgoing, time_t thread);
time_t post_article(char *board, char *title, char *file, char *id, char *nickname, char *ip, int sig, int mark, int outgoing, char *realauthor, time_t thread);
...
char *void1(char *s);
char *flag_str_bm(unsigned int access);
char *flag_str(unsigned int access);
char *flag_str2(unsigned int access, int has_read);
