#include "bbslib.h"
static void
printkickitem(const struct user_info *x)		//modify by mintbaggio@BMY
{
...
/*	printf
	...
	printf
            ("<td><a onclick='return confirm(\"你真的要踢出该用户吗?\")' href=kick?k=%s&f=%s>Kick</a></td></tr>",
             x->userid, x->from);
}
...
printkicklist(const char *usertokick)
{
	...
	printf
	    ("<tr><td>序号</td><td>使用者代号</td><td>使用者昵称</td><td>动态</td><td>发呆</td><td>踢人</td></tr>\n");
