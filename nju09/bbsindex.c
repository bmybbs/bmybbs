...
/* { */ char *login_link;
  ...
  "</tr>\n"
    "<tr>" 
    "<td align=center><html xmlns:wb='http://open.weibo.com/wb'><script src='http://tjs.sjs.sinajs.cn/open/api/js/wb.js' type='text/javascript' charset='utf-8'></script><wb:follow-button uid='1920805114' type='red_3' width='340' height='24' ></wb:follow-button> <img src=\"images/renren.gif\" > <iframe scrolling='no' frameborder='0' allowtransparency='true' src='http://widget.renren.com/plugin/followbutton?page_id=600748455&color=0&model=1' style='width:150px;height:24px;' ></iframe><td></html>" 
    "</tr>\n" 
    "<tr>"
