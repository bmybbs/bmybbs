...
/* { */ char *login_link;
	...
	printf("<body bgcolor=#efefef leftmargin=0 topmargin=0 onload='document.l.id.focus();'>\n"
		...
		"<table width=780 border=0 align=center cellpadding=0 cellspacing=0 bgcolor=#FFFFFF>\n"
               "<tr>\n<td height=35 align=right class=0004><a href='http://bbs.xjtu6.edu.cn' class=linkindex>IPV6登录</a>" 
               "/ <a href='javascript:lg();' class=linkindex>匿名登录</a>"
				"/ <a href='telnet://" MY_BBS_DOMAIN "' class=linkindex>telnet登录</a> /"
               "<a href='CTerm.rar' class=linkindex>CTerm工具下载</a><font color=#FFFFFF> \n"
		"/</font></font> </td>\n"
		"</tr>\n <tr> \n"
	...
	"</tr>\n"
		...
		"<form name=l action=/" SMAGIC "/bbslogin method=post><td>\n"
                ...
                "<td>&nbsp&nbsp&nbsp<input name=login_btn type=image id=login_btn src=\"images/index_log.gif\" width=40 height=18 border=0 onMouseOver=\"this.src='images/index_log2.gif'\" onMouseOut=\"this.src='images/index_log.gif'\">" 
               "&nbsp&nbsp&nbsp&nbsp&nbsp<a href='javascript:lg();'> <img border='0' src=\"images/guest.gif\" ></a>" 
                "&nbsp&nbsp<a href='http://bmy.xjtu.edu.cn'> <img border=0 src=\"images/wap.gif\" ></a>" 
                "&nbsp&nbsp&nbsp&nbsp&nbsp<a href='javascript:openreg();'> <img border='0' src=\"images/register.gif\" ></a>" 
               "</td>\n"
	//add by liuche@BMY 20120205
               "<td>&nbsp&nbsp<a href='/" SMAGIC "/bbsfindpass' target='_blank'><img border='0' src=\"images/find.gif\"></a></td>\n" 
		"</form></tr></table>\n"
        "<br />"		
  ...
  "</tr>\n"
    "<tr>" 
    "<td align=center><html xmlns:wb='http://open.weibo.com/wb'><script src='http://tjs.sjs.sinajs.cn/open/api/js/wb.js' type='text/javascript' charset='utf-8'></script><wb:follow-button uid='1920805114' type='red_3' width='340' height='24' ></wb:follow-button> <img border=0 src=\"images/renren.gif\" > <iframe scrolling='no' frameborder='0' allowtransparency='true' src='http://widget.renren.com/plugin/followbutton?page_id=600748455&color=0&model=1' style='width:150px;height:24px;' ></iframe><td></html>" 
    "</tr>\n" 
    "<tr>\n"
    "<td align=center bgcolor=#FFFFFF><img src=\"images/index_line.gif\" name=Image1 width=650 height=20 id=Image1></td>" 
    "</tr>\n" 
  "<tr><td></td> <td align=center>陕ICP备 05001571号<td></tr>"
	"</tr>\n"
