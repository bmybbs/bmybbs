...
const struct scommandlist sysconf_cmdlist[] = {
	...
	{"RECITE", (void *) x_recite}, {"NCCE", (void *) x_ncce}, {"CHESS",
								   (void *)
								   x_chess},
	{"QKMJ", (void *) x_qkmj}, {"ShowUser", (void *) x_showuser},
	...
	{"GroupSend",
	 (void *) g_send},
	{"OverrideSend", (void *) ov_send}, {"SendNetMail",
					     (void *) m_internet},
	...
	{"SetFriends", (void *) t_friend}, {"SetRejects",
					    (void *) t_reject},
	{"FriendWall", (void *) friend_wall}, {"EnterChat", ent_chat},
	...
	{"CleanMail", (void *) m_mclean}, {"EditSFiles", (void *) a_edits},
	{"EditSFiles2",(void*)a_edits2},
	{"Announceall", (void *) wall}, {"Setsyspass",
					 (void *) setsystempasswd},
	{"ShellOut", (void *) x_csh}, {"FCode", (void *) switch_code},
